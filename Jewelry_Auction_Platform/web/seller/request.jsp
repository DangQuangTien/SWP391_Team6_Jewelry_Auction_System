        ...
        <main class="container mt-4">
            ...
            <form id="valuationForm" name="valuationForm" ng-submit="submitForm(valuationForm.$valid)" novalidate>
                <div class="form-group">
                    ...
                    <span style="color:red" ng-show="valuationForm.name.$dirty && valuationForm.name.$invalid">
                ...
                <div class="form-group">
                    ...
                    <span style="color:red" ng-show="valuationForm.email.$dirty && valuationForm.email.$invalid">
                        <span ng-show="valuationForm.email.$error.required">Email is required.</span>
                        <span ng-show="valuationForm.email.$error.email">Invalid email address.</span>
                    </span>
                </div>
                <div class="form-group">
                    ...
                    <span style="color:red" ng-show="valuationForm.phone.$dirty && valuationForm.phone.$invalid">
                ...
                <div class="form-group">
                    ...
                    <span style="color:red" ng-show="valuationForm.communication.$dirty && valuationForm.communication.$invalid">
